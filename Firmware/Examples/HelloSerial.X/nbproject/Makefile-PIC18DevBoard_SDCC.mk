...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-PIC18DevBoard_SDCC.mk dist/${CND_CONF}/${IMAGE_TYPE}/HelloSerial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/HelloSerial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  --debug-ralloc -Wl-c -Wl-m --use-non-free --pstack-model=small -D__18F4520 -D_HARDWARE_PIC18DEVBOARD -I".\source" -I"..\..\Drivers" -I"..\..\HardwareProfiles" -mpic16 -p18f4520 ${OBJECTFILES}  -odist/${CND_CONF}/${IMAGE_TYPE}/HelloSerial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} 
else
dist/${CND_CONF}/${IMAGE_TYPE}/HelloSerial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC}  --debug-ralloc -Wl-c -Wl-m --use-non-free --pstack-model=small -D__18F4520 -D_HARDWARE_PIC18DEVBOARD -I".\source" -I"..\..\Drivers" -I"..\..\HardwareProfiles" -mpic16 -p18f4520 ${OBJECTFILES}  -odist/${CND_CONF}/${IMAGE_TYPE}/HelloSerial.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
